            ...
            >
              <div className="flex items-center lg:items-start gap-2 lg:gap-3">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center">
                  ...
                  <p className="hidden lg:block text-xs/snug sm:text-sm/snug text-zinc-500 transition-colors group-hover:text-zinc-600 dark:text-zinc-500 dark:group-hover:text-zinc-400">
                    {genEd.description}
                  </p>
                </div>
              </div>
