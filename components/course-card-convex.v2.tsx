...
export function ConvexCourseCardLinkV2({
  ...
  const isScheduled = useIsCourseScheduled(course.courseCode)
    ...
    <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
      <article
        className={cn(
          ...
          isScheduled
            ? "border-primary bg-primary/5 hover:border-primary hover:bg-primary/10 dark:border-primary dark:bg-primary/10 dark:hover:border-primary dark:hover:bg-primary/20"
            : "border-zinc-200/80 bg-white hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-800/80 dark:bg-zinc-900/20 dark:hover:border-zinc-700 dark:hover:bg-zinc-900/60",
          className
        )}
      >
        <div>
          ...
          <h4 className="mb-3 line-clamp-2 font-normal text-left text-sm leading-snug text-zinc-600 transition-colors group-hover:text-zinc-700 dark:text-zinc-400 dark:group-hover:text-zinc-300">
            {course.title}
          </h4>
